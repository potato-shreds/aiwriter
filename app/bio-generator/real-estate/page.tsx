...
const EssayHookGenerator: React.FC = () => {
  ...
  // Default
  const ToolType = 2;
  const activeTool = 'Real Estate Bio Generator';
  ...
  return (
    <div>
      ...
      <meta
        name="description"
        content="An efficient and reliable tool for crafting compelling real estate agent bios that attract potential clients. Stand out in the market with a professional bio."
      />
      <meta
        name="keywords"
        content="Real Estate Bio Generator, real estate agent bio, create real estate bio, compelling bios, attract clients, professional bios, real estate marketing tool"
      />
      <Header />
