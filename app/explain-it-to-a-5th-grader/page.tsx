...
const EssayHookGenerator: React.FC = () => {
  ...
  // Default
  const ToolType = 2;
  const activeTool = 'Explain it to a 5th Grader';
  const [responseDate, setResponseDate] = useState<responseDateObject[]>([]);

  return (
    <>
      <title>
        Explain it to a 5th Grader:Get a simple and clear explanation of
        something so even a 5th grader can understand it easily.
      </title>
      <meta
        name="description"
        content="This is a tool to count words in your writing quickly."
      />
      <meta name="keywords" content="Word Counter, count words, writing tool" />
      <Header />
