...
const v3: React.FC = () => {
  return (
    <div className="h-full flex flex-col items-center justify-center py-5">
      <div className="w-full md:w-1/2 bg-white p-10 rounded shadow-xl text-center h-full flex flex-col justify-between">
        <Image
          className="h-16 w-16 mb-5 self-start"
          src="https://is1-ssl.mzstatic.com/image/thumb/Purple116/v4/20/ee/17/20ee170e-b8d6-2d43-4dc5-8d50d7fe4b78/AppIcon-0-0-1x_U007emarketing-0-0-0-6-0-0-sRGB-0-0-0-GLES2_U002c0-512MB-85-220-0-0.png/246x0w.webp"
          alt="AI Writer App Logo"
          width={246}
          height={0}
        />
        <div>
          ...
          <p className="text-lg mb-10">
            ...
            intelligence to assist you with your writing. Whether you are
            working on a novel, an essay, or simply drafting an email, AI Writer
            is your perfect writing companion.
          </p>
