...
const EssayHookGenerator: React.FC = () => {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Craft customized privacy policies for your website with HIX Writer’s Free Privacy Policy Generator. Ensure compliance with legal standards and protect user data effortlessly."
      />
      <meta
        name="keywords"
        content="Privacy Policy Generator, create privacy policy, customized privacy policies, free privacy policy generator, website privacy policy, legal compliance, protect user data"
      />
      ...
      <div className="pb-12 relative overflow-hidden sm:pb-6 bg-gradient-to-b from-[#E8ECF8] to-white z-0 after:absolute after:left-0 after:-translate-x-[70%] after:top-0 after:w-full after:h-1/2 after:z-[-1] after:rounded-full after:blur-3xl after:bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] after:from-[#22C9A4] after:via-[#6A51FF] after:to-[#ECF4FF] after:opacity-25">
        <AiWritingToolsTitle
          title={activeTool}
          desc="Craft customized privacy policies for your website with HIX Writer’s Free Privacy Policy Generator."
        />
      </div>
      <div className="mt-5">
        <ToolsMain
