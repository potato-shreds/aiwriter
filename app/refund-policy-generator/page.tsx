...
const EssayHookGenerator: React.FC = () => {
  ...
  // Default
  const ToolType = 2;
  const activeTool = 'Refund Policy Generator';
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Generate top-tier refund policy templates for your business in just a few clicks. Ensure customer satisfaction and legal compliance with our easy-to-use tool."
      />
      <meta
        name="keywords"
        content="Refund Policy Generator, create refund policy, refund policy template, business refund policy, customer satisfaction, legal compliance, online refund tool"
      />
      ...
      <div className="pb-12 relative overflow-hidden sm:pb-6 bg-gradient-to-b from-[#E8ECF8] to-white z-0 after:absolute after:left-0 after:-translate-x-[70%] after:top-0 after:w-full after:h-1/2 after:z-[-1] after:rounded-full after:blur-3xl after:bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] after:from-[#22C9A4] after:via-[#6A51FF] after:to-[#ECF4FF] after:opacity-25">
        <AiWritingToolsTitle
          title={activeTool}
          desc="Generate top-tier refund policy templates for your business in just a few clicks."
        />
      </div>
      <div className="mt-5">
        <ToolsMain
