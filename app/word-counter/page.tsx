...
const EssayHookGenerator: React.FC = () => {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Count how many words a text has in seconds with our efficient Word Counter. Perfect for writers, students, and professionals!"
      />
      <meta
        name="keywords"
        content="Word Counter, count words, online word count tool, text analysis, writing tool, word counting, quick word counter"
      />
      <Header />
      <div className="pb-12 relative overflow-hidden sm:pb-6 bg-gradient-to-b from-[#E8ECF8] to-white z-0 after:absolute after:left-0 after:-translate-x-[70%] after:top-0 after:w-full after:h-1/2 after:z-[-1] after:rounded-full after:blur-3xl after:bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] after:from-[#22C9A4] after:via-[#6A51FF] after:to-[#ECF4FF] after:opacity-25">
        <AiWritingToolsTitle
          title={activeTool}
          desc="Count how many words a text has in seconds."
        />
      </div>
      <div className="mt-5">
        <ToolsMain
